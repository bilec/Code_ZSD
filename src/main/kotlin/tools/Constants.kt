...
class Constants {
    ...
    companion object{
        ...
        const val ENCODE_TAB = "Kódovanie"
        const val DECODE_TAB = "Dekódovanie"
        const val SUPER_ENCODE_TAB = "SUPER=KODOVANIE"
        const val SUPER_DECODE_TAB = "SUPER=DEKODOVANIE"
        const val NEW_WORDS_TAB = "Pridanie nových slov"
        const val SHOW_DICTIONARY_TAB = "Zobrazenie slovníka a tabuliek"

        const val ENCODE_BUTTON = "Kóduj"
        const val DECODE_BUTTON = "Dekóduj"
        const val SUPER_ENCODE_BUTTON = "SUPER=KODUJ"
        const val SUPER_DECODE_BUTTON = "SUPER=DEKODUJ"
        ...
        const val TABLE_NUM_1 = "Tabuľka č. 1"
        const val TABLE_NUM_2 = "Tabuľka č. 2"
        const val TABLE_NUM_3 = "Tabuľka č. 3"
        const val TABLE_NUM_4 = "Náhodná tabuľka č. 4"
        const val TABLE_NUM_5 = "Náhodná tabulka c. 5"
        ...
        const val TABLE_NUM_1_PART_1 = "$SHOW_ENTRY_TABLE_PREFIX 1 - $SHOW_ENTRY_FIRST_PAGE_POSTFIX"
        const val TABLE_NUM_1_PART_2 = "$SHOW_ENTRY_TABLE_PREFIX 1 - $SHOW_ENTRY_SECOND_PAGE_POSTFIX"

        const val TABLE_NUM_2_PART_1 = "$SHOW_ENTRY_TABLE_PREFIX 2 - $SHOW_ENTRY_FIRST_PAGE_POSTFIX"
        const val TABLE_NUM_2_PART_2 = "$SHOW_ENTRY_TABLE_PREFIX 2 - $SHOW_ENTRY_SECOND_PAGE_POSTFIX"

        const val TABLE_NUM_3_PART_1 = "$SHOW_ENTRY_TABLE_PREFIX 3 - $SHOW_ENTRY_FIRST_PAGE_POSTFIX"
        const val TABLE_NUM_3_PART_2 = "$SHOW_ENTRY_TABLE_PREFIX 3 - $SHOW_ENTRY_SECOND_PAGE_POSTFIX"
        const val TABLE_NUM_3_PART_3 = "$SHOW_ENTRY_TABLE_PREFIX 3 - $SHOW_ENTRY_THIRD_PAGE_POSTFIX"
        const val TABLE_NUM_3_PART_4 = "$SHOW_ENTRY_TABLE_PREFIX 3 - $SHOW_ENTRY_FOURTH_PAGE_POSTFIX"

        const val TABLE_NUM_4_PART_1 = "$SHOW_ENTRY_RANDOM_TABLE_PREFIX 4 - $SHOW_ENTRY_FIRST_PAGE_POSTFIX"
        const val TABLE_NUM_4_PART_2 = "$SHOW_ENTRY_RANDOM_TABLE_PREFIX 4 - $SHOW_ENTRY_SECOND_PAGE_POSTFIX"

        const val TABLE_NUM_5_PART_1 = "$SHOW_ENTRY_RANDOM_TABLE_PREFIX 5 - $SHOW_ENTRY_FIRST_PAGE_POSTFIX"
        const val TABLE_NUM_5_PART_2 = "$SHOW_ENTRY_RANDOM_TABLE_PREFIX 5 - $SHOW_ENTRY_SECOND_PAGE_POSTFIX"
        const val TABLE_NUM_5_PART_3 = "$SHOW_ENTRY_RANDOM_TABLE_PREFIX 5 - $SHOW_ENTRY_THIRD_PAGE_POSTFIX"
        const val TABLE_NUM_5_PART_4 = "$SHOW_ENTRY_RANDOM_TABLE_PREFIX 5 - $SHOW_ENTRY_FOURTH_PAGE_POSTFIX"

        val TABLE_PARTS = arrayOf(TABLE_NUM_1_PART_1, TABLE_NUM_1_PART_2, TABLE_NUM_2_PART_1, TABLE_NUM_2_PART_2,
